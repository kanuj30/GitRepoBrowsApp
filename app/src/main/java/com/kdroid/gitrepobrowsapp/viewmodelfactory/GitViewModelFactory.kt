...
class GitViewModelFactory constructor(private val repository: GitRepository,private val apiHelper: ApiHelper) :
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return if (modelClass.isAssignableFrom(MainViewModel::class.java)) {
            ...
            RepoDetailViewModel(this.repository,this.apiHelper) as T
        } else {
